...
Datadog Lambda Library for Node.js (18.x, 20.x, 22.x, 24.x, 26.x) enables enhanced Lambda metrics, distributed tracing, and custom metric submission from AWS Lambda functions.
